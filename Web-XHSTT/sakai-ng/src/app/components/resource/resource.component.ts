...
export class ResourceComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.service.getAll().subscribe((x) => {
            this.items = this.sortByDescending(x.Resource);
        ...
        this.cols = [
            ...
            { field: 'ResourceType', header: 'ResourceType' },
            { field: 'ResourceGroups', header: 'ResourceGroups' },
        ];
    ...
    sortByDescending(x: Resource[]): Resource[] {
